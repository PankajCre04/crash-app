...
class ProductsProvider with ChangeNotifier {
  ...
  List<ProductModel> get getSaleProducts {
    return _productsList.where((produc) => produc.isOnSale).toList();
  }
  ...
  List<ProductModel> findByCaegory(String categoryName) {
    List<ProductModel> _categoryList = _productsList
        .where((element) => element.productCategoryName.toLowerCase().contains(
